<template>
    <section class="px-6 py-8" id="app">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <router-link to="/">
                    <img :src="images.logo" alt="Laracasts Logo" width="165" height="16">
                </router-link>
            </div>
        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            <img :src="images.newsletterIcon"  alt="" class="mx-auto -mb-6" style="width: 145px;">
                    ...
                    <form @submit.prevent="subscribe" class="lg:flex text-sm">
                        <div class="lg:py-3 lg:px-5 flex items-center">
                            <label for="email" class="hidden lg:inline-block">
                                <img :src="images.mailboxIcon" alt="mailbox letter">
                            </label>
                            <div>
